                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        ...
                                        <a href="{{ route('superadmin.tender.index') }}"
                                            class="small-box-footer">{{ __('panel.dash-view-tenders') }} <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        ...
                                        <a href="{{ route('superadmin.tender.pending') }}"
                                            class="small-box-footer">{{ __('panel.dash-view-tenders') }} <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-info">
                                        ...
                                        <a href="{{ route('superadmin.document.index') }}"
                                            class="small-box-footer">{{ __('panel.dash-view-documents') }} <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
