...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        @if (Auth::user()->role->id == '3')
            <a href="{{route('admin.dashboard')}}" class="brand-link">
                ...
                width="48" height="48">
                <span class="brand-text font-weight-bold" style="font-size: 15px;">{{ trans('navbar.btr') }}</span>
            </a>
        @endif
        ...
        @if (Auth::user()->role->id == '1')
            <a href="{{route('serveradmin.dashboard')}}" class="brand-link m-0">
                <img src="{{ asset('public/assets/images/bandhavgarh_logo.png') }}" alt="BTR-Logo" class="brand-image img-circle elevation-3"
                width="48" height="48">
                <span class="brand-text font-weight-bold" style="font-size: 15px;">{{ trans('navbar.btr') }}</span>
            </a>
                            ...
                            @if (Request::is('admin*'))
                                ...
                                @if (session('locale') == 'en')
                                    <li class="nav-item">
                                        <a href="{{ route('admin.dashboard') }}" class="nav-link {{ 'admin/dashboard' == request()->path() ? 'active' : '' }}">
                                            ...
                                            <p>Dashboard <span class="right badge rounded-pill badge-light pt-1 pb-1 pl-2 pr-2">English</span></p>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (session('locale') == 'hi')
                                    <li class="nav-item">
                                        <a href="{{ route('admin.dashboard') }}" class="nav-link {{ 'admin/dashboard' == request()->path() ? 'active' : '' }}">
                                            <i class="nav-icon fas fa-tachometer-alt"></i>
                                            <p>डैशबोर्ड <span class="right badge rounded-pill badge-light pt-1 pb-1 pl-2 pr-2">हिंदी</span></p>
                                        </a>
                                    </li>
                                @endif
    ...
    <footer class="main-footer">
        ...
        @endif
        @if (Auth::user()->role->id == '1')
            <strong><a href="{{route('serveradmin.dashboard')}}">{{ trans('navbar.btr') }}</a>.</strong>
        @endif
