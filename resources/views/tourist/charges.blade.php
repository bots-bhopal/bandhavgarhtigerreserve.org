...
@push('css')
    <style>
        ...
        .note {
            ...
            font-size: 1.1em;
            padding: 4px;
            box-shadow: 2px 2px 3px 0.3px rgba(0, 0, 0, 0.4);
        }
                        ...
                        <div class="text-content text-justify">
                                ...
                                <table class="table table-bordered" style="border-color: #000;">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <th scope="row" rowspan="3" class="align-middle text-center">
                                                {{ __('tourist.t2.th5') }}</th>
                                        ...
                                        <tr class="text-center">
                                            <th scope="row" rowspan="6" class="align-middle text-center">
                                                {{ __('tourist.t2.th6') }}</th>
                            ...
                            <ul class="pl-3">
                                <li class="pb-3">
                                    <b>
                                        <u>
                                            <h4 style="font-size: 1.5em;">{{ trans('tourist.safari-heading') }}</h4>
                                        </u>
                                    </b>
                                </li>
                                <b>
                                    <p>{{ trans('tourist.safari-p1') }}</p>
                                    <p>{{ trans('tourist.safari-p2') }}</p>
                                </b>

                                <p class="note">{{ trans('tourist.note-1') }}</p>
                            </ul>
