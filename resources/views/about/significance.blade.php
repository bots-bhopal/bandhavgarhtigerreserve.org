                    ...
                    <div class="text-box mt-40">
                        <div class="text-content text-justify">
                            ...
                            <ul>
                                ...
                                <li class="mb-3">{{ trans('about.significance-l8') }}</li>
                                <li class="mb-3">{{ trans('about.significance-l9') }}</li>
                                <li class="mb-3">{{ trans('about.significance-l10') }}</li>
                                <li class="mb-3">{{ trans('about.significance-l11') }}</li>
                            </ul>
