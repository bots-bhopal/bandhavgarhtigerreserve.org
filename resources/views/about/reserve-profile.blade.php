                ...
                <div class="col-lg-8 col-md-7">
                    ...
                    <div class="text-box mt-40">
                        <div class="text-content text-justify">
                            ...
                            <p><b>{{ trans('about.longitude') }} 80&deg; 43' 15" to 81&deg; 15' 45"
                                    {{ trans('about.east') }}</b></p>
                            <p><b>{{ trans('about.latitude') }} 23&deg; 27' 00'' to 23&deg; 59' 50"
                                    {{ trans('about.north') }}</b></p>
                            ...
                            {{-- <br />
                            <p><b>{{ trans('about.core') }}</b> {{ trans('about.tala') }}</p>

                            <br />
                            <p><b>{{ trans('about.buffer') }}</b> {{ trans('about.dhamokhar') }}</p> --}}
                        </div>
                    </div>
                </div>
            </div>
