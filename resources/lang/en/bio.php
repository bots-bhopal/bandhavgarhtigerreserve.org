...
return [
    ...
    'introduction-p3'   =>  'Within its broad moist and dry forests, which cover almost all area of the BTR, It also consists of few small pockets of microhabitats. These micro habitats are very sensitive and important since some plant species are only confined in these microhabitats. The major Ecologically Sensitive Areas are AndhiaryJiriya,BhitriVah (The open marshy grasslands known as \'Vahs\'), Chakradhara Meadow, KetkihaVah, Sehara meadow and KerhaVah. Also because of Habitat developmental measures taken by the management, the overall water availability within the habitat has improved.',
    'flora-p1'  =>  'For the general understanding purpose, the forest of BTR may be termed as ‘Moist Mixed Deciduous Forest with predominance of Sal’ and it may be classified in following categories:',
    'flora-l1'  =>  'Sal Forest',
    'flora-l2'  =>  'Mixed Forest',
    'flora-l3'  =>  'Grasslands',
    'flora-p2'  =>  'Trees, Plants, and Grasses which are commonly found in BTR are:',
    'flora-p3'  =>  'Sal (<i>Shorearobusta</i>), Saj (<i>Terminalia tomentosa</i>), Mahua (<i>Madhuca indica</i>), Haldu (<i>Adina cardifolia</i>), Dhaora/Dhavda (<i>Anogeissus latifolia</i>), Tendu (<i>Diospyros melanoxylon</i>),Baheda(<i>Terminalia bellerica</i>), Arjun (<i>Terminalia arjuna</i>), Amla (<i>Emblica officinalis</i>), Palas (<i>Butea monosperma</i>), Salai (<i>Boswellia serrata</i>), Bhirra (<i>Chloroxylon sweitenia</i>), Gamar (<i>Gmelina arborea</i>), Dhaman (<i>Grewia tilifolia</i>), Mango (<i>Mangifera indica</i>), Jamun (<i>Syzygiumcumini</i>), Lendia (<i>Lagerstroemia parviflora</i>), Wild luck (<i>Flemingia bracteate</i>), Hairy gomphrena (<i>Acrocephalus indicus</i>),Van Tambakhu (<i>Elephantopusscaber</i>), Bamboo (<i>Dendrocalamusstrictus</i>), Indian Gooesgrsass (<i>Eleusine indica</i>),Red grass (<i>Themedatriandra, Themeda quadrivalvis</i>),Dubia grass (<i>Crysopogonmontanus</i>), Poledi (<i>Apludamutiuca</i>), Tall reed grass (<i>Phragmites karka</i>), Khas (<i>Chrysopogonzizanioides</i>), Kans(<i>Saccharum spontaneum</i>) etc.',
    'fauna-p1'  =>  'Over 47 kinds of mammals, more than 250 species of birds, more than 100 plus species of butterflies and 16 kinds of snakes is testimony to the fact that the rich habitat diversity of Bandhavgarh Tiger Reserve supports wide range of animal communities viz.: mammals, birds, reptiles and many lesser life forms in the Reserve. The central meadows of Bandhavgarh (Tala range) are rich in ungulates, tigers and other species of fauna.',
    'fauna-p2'  =>  'Main Fauna',
    'fauna-p3'  =>  'Mammals',
    'fauna-p4'  =>  'The Prominent mammal species of Bandhavgarh are:',
    'fauna-l1'  =>  'Spotted deer or Chital (<i>Axisaxis</i>)',
    'fauna-l2'  =>  'Sambar (<i>Cervus unicolor</i>)',
    'fauna-l3'  =>  'Barking deer or Muntjac (<i>Muntiacusmuntjak</i>)',
    'fauna-l4'  =>  'Chousingha or Four-horned antilope (<i>Tetracerusquadricornis</i>)',
    'fauna-l5'  =>  'Nilgai or Blue bull (<i>Boselaphustragocamelus</i>)',
    'fauna-l6'  =>  'Indian Gazelle or Chinkara (<i>Gazellabenetti</i>)',
    'fauna-l7'  =>  'Gaur (<i>Bos gaurus</i>)',
    'fauna-l8'  =>  'Tiger (<i>Panthera tigristigris</i>)',
    'fauna-l9'  =>  'Leopard (<i>Pantherapardus</i>)',
    'fauna-l10'  =>  'Wild dog or Dhole (<i>Cuonalpinus</i>)',
    'fauna-l11'  =>  'Hyaena (<i>Hyaena hyena</i>)',
    'fauna-l12'  =>  'Indian Wolf (<i>Canis lupus</i>)',
    'fauna-l13'  =>  'Jackal (<i>Canis aureus</i>)',
    'fauna-l14'  =>  'Wild boar (<i>Sus scrofa</i>)',
    'fauna-l15'  =>  'Sloth bear (<i>Metursusursinus</i>)',
    'fauna-l16'  =>  'Common langur (<i>Semnopithecusentellus</i>)',
    'fauna-l17'  =>  'Rhesus monkey (<i>Macaque mulata</i>)',
    'avifauna-p1'   =>  'Even though Bandhavgarh is mainly famous for Tiger and other large mammals but regular tourists come to the reserve who are keen to move around in the park to catch the glimpses of Bandhavgarh’s rich Avifauna. More than 250 species of birds have been identified in the Reserve. Many water birds can be seen in the park and there are some migratory birds too which can be found in the park during the winter season.',
    ...
    'avifauna-l13'   =>  'Malabar pied Hornbill',
    'avifauna-l14'   =>  'Stork billed kingfisher',
    'avifauna-l15'   =>  'Sirkeer Malkoha',
    'avifauna-l16'   =>  'Mottled wood owl',
    'avifauna-l17'   =>  'Osprey ',
    'avifauna-l18'   =>  'Eurasian sparrow Hawk',
    'avifauna-l19'   =>  'Cinnamon Bittern',
    'avifauna-l20'   =>  'Barbets',
    'avifauna-p3'   =>  'Three of the four species of vultures resident in Bandhavgarh; Oriental White-backed Vulture, Indian vulture or the Long-billed Vulture and Red-headed Vulture have been identified to be having high risk of global extinction and are listed as Critically Endangered in the IUCN list. The fourth, Egyptian Vulture has been categorised as Endangered. Due to presence of many hillocks, cliffs and elevated areas its common to see the nesting colonies of Vultures inside the park which raises the hope that all is not lost for these birds.',
    'butterflies-p1'    =>  'Butterflies are one of the most beautiful creations of nature. They are such tiny creatures but the interests of some wildlife lovers in Butterflies is enormous. Around 110 Species of butterflies have been identified in the park. Some of them are:',
    ...
    'rare-l5'   =>  'Fishing Cat',
    'rare-p8'   =>  'The fishing cat (Prionailurusviverrinus) is a medium-sized wild cat mainly found in South and Southeast Asia and is listed as Vulnerable on the IUCN Red List. Fishing cat populations have declined severely in the last decade. They are mostly found in the vicinity of wetlands.',
];
